...
class RiceStockScreen extends StatelessWidget {
  ...
  void _showAddDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text('Add Rice Stock'),
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                TextField(decoration: const InputDecoration(labelText: 'Rice (Kg)'), keyboardType: TextInputType.number),
                const SizedBox(height: 8),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        ...
        children: const [
          Center(child: Text('No Rice Stock entries found.')),
        ],
      ),
